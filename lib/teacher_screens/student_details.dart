        ...
        data.documents.forEach((f) {
          if (f.data['classno']==_selectClass.Name||'select Class'==_selectClass.Name){
            listForDetail.add(DetailsModel(id: f.data['id'],
                ...
                NextFeesMonth: f.data['NextFeesMonth'],
                NextFeesPaid: f.data['NextFeesPaid'],
                LastFeesMonth: f.data['LastFeesMonth'],
                LastFeesPaid: f.data['LastFeesPaid'],
                LastFeesYear: f.data['LastFeesYear'],
                NextFeesYear: f.data['NextFeesYear'],
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                            ...
                            new MaterialPageRoute(
                                ...
                                FeesStatus(title : '${listForDetail[index].fname}',id :'${listForDetail[index].documentId  }',listForDetail:listForDetail[index])));
                      },
                    );
                  }),
